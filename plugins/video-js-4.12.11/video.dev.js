...
if (vjs.CDN_VERSION !== 'GENERATED'+'_CDN_VSN') {
  videojs.options['flash']['swf'] = vjs.ACCESS_PROTOCOL + 'vjs.zencdn.net/'+vjs.CDN_VERSION+'/video-js-4.12.11.swf';
}
...
vjs.Player.prototype.createEl = function(){
  ...
  // doesn't flash 100% width/height, but class only applies with .video-js-4.12.11 parent
  tag.id += '_html5_api';
...
// currently not triggered by video-js-4.12.11-swf
...
vjs.Flash = vjs.MediaTechController.extend({
  ...
  init: function(player, options, ready){
    ...
    // firefox doesn't bubble mousemove events to parent. videojs/video-js-4.12.11-swf#37
